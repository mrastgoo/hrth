\begin{tikzpicture} [scale=0.68,every node/.style={scale=0.68}]  %[scale=.68]
...
\def\reward{62.39,72.65,82.05,88.03,93,88.89,89.74,90,76.92}
\def\spec{82.47,88.31,85.71,90.91,78,94.16,90.91,89,90.26}
\def\cZoom{5} 
